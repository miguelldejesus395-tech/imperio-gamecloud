...
const STREAM_AGENT_KEY =
  String(process.env.STREAM_AGENT_KEY || '');
...
const server =
  http.createServer(
    async (
      ...
      /*
       * Limite de tentativas apenas
       * para operações de autenticação.
       */
      const rateLimitedPath =
        pathname ===
          '/api/login' ||
        pathname ===
          '/api/users/register' ||
